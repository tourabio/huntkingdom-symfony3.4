...
public class JavaMailPayment {
    ...
    String myAccount="mohamedsayed.tourabi@esprit.tn";//il va changé selon le mazil de l'admin
    String password="182JMT0297";//il va changé selon le mazil de l'admin
...
"                                                <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"spacer\" style=\"font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%\"><tbody><tr><td height=\"35\" class=\"spacer\" style=\"font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%\">&nbsp;</td></tr></tbody></table>\n" +
"\n" +
"                                                <div class=\"h3-1-center\" style=\"color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center\">Thank you for your final payment on your HuntKingdom application. We appreciate the prompt manner in which you have made these payments.We hope that you are satisfied by our services.</div>\n" +
...
"</body></html>";
       ...
       FileDataSource fds = new FileDataSource(filePath);
        ...
        message.setContent(multipart);
            ...
            Logger.getLogger(JavaMailPayment.class.getName()).log(Level.SEVERE, null, ex);
        }
          return null;
    }
